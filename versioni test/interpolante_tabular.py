...
d1=100                                              #no. of divisions of domain axis
d2=100
d3=100
...
Tab = numpy.zeros((d1+1,d2+1,d3+1))                  #the tabular
...
print("iterpolated value   :", g(a,b,c,X0,Y0,Z0,Tab))
